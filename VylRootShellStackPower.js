...
import { NavigationContainer as NavVylRoot } from '@react-navigation/native';
import { createNativeStackNavigator as spinRavStack } from '@react-navigation/native-stack';
import GlimStormLoadRune from './GlimmerSkyYourVegasDaysSrc/GlimmerSkyYourVegasDaysScreens/GlimmerSkyYourVegasDaysLoading';
import OnvyrGlimmTube from './GlimmerSkyYourVegasDaysSrc/GlimmerSkyYourVegasDaysScreens/GlimmerSkyYourVegasDaysOnboarding';
import { SafeAreaProvider as SafeVylShell } from 'react-native-safe-area-context';
import { GestureHandlerRootView as RuneGestHull } from 'react-native-gesture-handler';
import VeygornMainForge from './GlimmerSkyYourVegasDaysSrc/GlimmerSkyYourVegasDaysScreens/SkyrVaglurBox';
import ProductScreen from './GlimmerSkyYourVegasDaysSrc/GlimmerSkyYourVegasDaysScreens/ProductScreen';
const RavStackerForge = spinRavStack();
// libs
import AsyncStorage from '@react-native-async-storage/async-storage';
import { LogLevel, OneSignal } from 'react-native-onesignal';
import AppleAdsAttribution from '@vladikstyle/react-native-apple-ads-attribution';

const ButaneRavRoutes = () => {
  const RavScreen = RavStackerForge.Screen;
  const RavNavi = RavStackerForge.Navigator;

  const vylTransitions = {
    shadowDrift: { headerShown: false, animation: 'fade_from_bottom' },
    glimSoft: { headerShown: false, animation: 'fade' },
  };
  //////////////////////////////////////////////////////////////////////////////////////////
  ...
  const INITIAL_URL = `https://fresh-zone-space.site/`;
  const URL_IDENTIFAIRE = `Ubn4jYP8`;
  ...
  OneSignal.initialize('57917b45-e2a4-4d65-99c9-39da32614824');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2026-01-09T08:08:00'); //дата з якої поч працювати webView
  ...
  const Route = ({ isFatch }) => {
    ...
    return (
      <RavNavi
        screenOptions={{
          contentStyle: { backgroundColor: '#650008' },
          animationEnabled: true,
        }}
        initialRouteName="GlimmerSkyYourVegasDaysOnboarding"
      >
        <RavScreen
          component={GlimStormLoadRune}
          name="GlimmerSkyYourVegasDaysLoading"
          options={{
            ...vylTransitions.shadowDrift,
            title: 'Storm Loading',
          }}
        />

        <RavScreen
          component={VeygornMainForge}
          name="SkyrVaglurBox"
          options={{
            ...vylTransitions.shadowDrift,
        ...
        <RavScreen
          component={OnvyrGlimmTube}
          options={{
            ...vylTransitions.glimSoft,
            title: 'Onboard Tubes',
          }}
          name="GlimmerSkyYourVegasDaysOnboarding"
        />
      </RavNavi>
    );
  };
        ...
        <View style={{ flex: 1, overflow: 'hidden' }}>
          ...
          >
            <Image
              ...
              source={require('./GlimmerSkyYourVegasDaysSrc/GlimmerSkyYourVegasDaysAssets/GlimmerSkyYourVegasDaysImages/1.png')}
              resizeMode="cover"
            />
            <Image
              style={{ width: screenWidth, height: '100%' }}
              source={require('./GlimmerSkyYourVegasDaysSrc/GlimmerSkyYourVegasDaysAssets/GlimmerSkyYourVegasDaysImages/2.png')}
              resizeMode="cover"
            />
          </Animated.View>
        </View>
...
const VylRootShell = () => {
  return (
    <RuneGestHull style={{ flex: 1, backgroundColor: '#0D0D0E' }}>
      <SafeVylShell>
        <ButaneRavRoutes />
      </SafeVylShell>
    </RuneGestHull>
